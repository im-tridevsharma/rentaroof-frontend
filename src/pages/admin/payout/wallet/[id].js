...
import { getWalletPayout, releasePayout } from "../../../../lib/payouts";
import { toast, ToastContainer } from "react-toastify";
import router from "next/router";

const AllRequest = () => {
  return (
    <Link href="/admin/payout/wallet">
...
function Index() {
  ...
  useEffect(() => {
    const payoutCall = async () => {
      setIsLoading(true);
      const payout = await getWalletPayout(router?.query?.id);
      if (payout?.status) {
